...
class CommandLexerTest extends FunSpec with Matchers {

  describe("Command lexer") {
    it("should parse command with params") {
      val expectedResult = List(LexedCommand("command", List(LexedParam("param1"), LexedParam("param2"))))
